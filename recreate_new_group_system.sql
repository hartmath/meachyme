-- Drop existing new group system tables and recreate them properly
-- This will fix the foreign key issues and ensure messages display correctly
...
-- Step 3: Create new_groups table
...
-- Step 5: Create new_group_messages table
...
-- Step 6: Enable RLS (but keep it simple)
...
-- Step 10: Create helper functions for the new system
...
-- Step 11: Enable real-time for the new tables
